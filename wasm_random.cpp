...
/**
 *
 * 1. WasmRandom does make random numbers difficult to predict, and random numbers
...
CONTRACT WasmRandom : public platon::Contract {
 public:
  struct Participant {
    u128 secret;
 ...
 public:
  ...
  ACTION void Commit(u128 campaign_id, const bytes32 &hs) {
    ...
    // check deposit
    if(platon_call_value() != one.deposit) platon_revert();
...
PLATON_DISPATCH(WasmRandom, (init)(NewCampaign)(Follow)(Commit)(Reveal)(GetRandom)(
